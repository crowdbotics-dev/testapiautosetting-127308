...
## Project Structure
    ...
    ├── testapiautosetting_127308  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127308`
...
2. Clone this repo and `cd testapiautosetting_127308`
